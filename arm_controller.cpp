...
void ArmController::measureMsgCallback(const std_msgs::String::ConstPtr &msg)
{

  ROS_INFO("Get measureMsgCallback  ");
  ...
  open_manipulator_msgs::GetJointPosition::Request reqJ ;
  open_manipulator_msgs::GetJointPosition::Response resJ ;
  getJointPositionMsgCallback(reqJ,resJ);

  open_manipulator_msgs::GetKinematicsPose::Request reqK  ;
  open_manipulator_msgs::GetKinematicsPose::Response resK  ;
  getKinematicsPoseMsgCallback(reqK,resK);
  ROS_INFO("getKinematicsPos = %.3f,%.3f,%.3f _  %.3f,%.3f,%.3f,%.3f",\
	resK.kinematics_pose.pose.position.x, resK.kinematics_pose.pose.position.y, resK.kinematics_pose.pose.position.z,\
	resK.kinematics_pose.pose.orientation.x, resK.kinematics_pose.pose.orientation.y, resK.kinematics_pose.pose.orientation.z, resK.kinematics_pose.pose.orientation.w);
...
void ArmController::initJointPosition()
{
  ...
  msg.position.push_back(0.000605);
  msg.position.push_back(0.000461);
  msg.position.push_back(0.000036);
  ...
  desired_pose.pose.position.x = 0.012 ;
  desired_pose.pose.position.y = 0.148 ;
  desired_pose.pose.position.z = 0.203 ;
  desired_pose.pose.orientation.x = -0.001 ;
  desired_pose.pose.orientation.y = 0.001 ;
  desired_pose.pose.orientation.z = 0.707 ;
  desired_pose.pose.orientation.w = 0.707 ;
  msg.group_name = "arm";
  msg.pose = desired_pose.pose;
...
void ArmController::initSubscriber(bool using_gazebo)
{
  ...
  position_measure_sub_ = nh_.subscribe("/measure", 10,
                                            &ArmController::measureMsgCallback, this);
}
